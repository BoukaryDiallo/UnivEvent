    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="{{ route('departement.show', $departement->id) }}" class="btn btn-secondary">
        ...
        <div class="col-lg-8 mx-auto">
            <div class="card shadow">
                <div class="card-header bg-warning text-white">
                    <h5 class="mb-0">
                        <i class="fas fa-edit me-2"></i>Modifier les informations du Département
                    </h5>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('departement.update', $departement->id) }}">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('nom') is-invalid @enderror" 
                                       id="nom" name="nom" value="Informatique" required>
                                @error('nom')
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('code') is-invalid @enderror" 
                                       id="code" name="code" value="DPT-INF" required>
                                @error('code')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      id="description" name="description" rows="4">Le département d'Informatique assure la formation dans les domaines des technologies de l'information, du développement logiciel, de l'intelligence artificielle et de la cybersécurité. Il prépare les étudiants aux métiers porteurs du numérique.</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('chef_departement') is-invalid @enderror" 
                                       id="chef_departement" name="chef_departement" value="Dr. Paul Ouattara">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror" 
                                       id="email" name="email" value="informatique@univ-event.bf">
                                @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="tel" class="form-control @error('telephone') is-invalid @enderror" 
                                   id="telephone" name="telephone" value="+226 25 30 45 70">
                            @error('telephone')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
