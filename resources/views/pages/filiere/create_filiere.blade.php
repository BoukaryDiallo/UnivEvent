                    ...
                    <form method="POST" action="{{ route('filiere.store') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('departement_id') is-invalid @enderror" id="departement_id" name="departement_id" required>
                                    ...
                                    <option value="1">DPT-INF - Informatique</option>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('niveau') is-invalid @enderror" id="niveau" name="niveau" required>
                                    ...
                                    <option value="licence_master">Licence - Master</option>
                                </select>
                                @error('niveau')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('duree') is-invalid @enderror" 
                                       id="duree" name="duree" value="{{ old('duree') }}" min="1" max="10">
                                @error('duree')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('conditions_admission') is-invalid @enderror" 
                                      id="conditions_admission" name="conditions_admission" rows="3">{{ old('conditions_admission') }}</textarea>
