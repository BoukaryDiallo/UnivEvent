...
export function JuryWorkbench({
    ...
    const handleSaveConfiguration = () => {
        submitAction(
            `/module5/events/${evenementId}/jury/configurer`,
            {
    ...
    const handleScore = (submit: boolean) => {
        ...
        submitAction(
            `/module5/events/${evenementId}/jury/participants/${effectiveParticipantId}/noter`,
            {
    ...
    const handleRequestRevision = () => {
        ...
        submitAction(
            `/module5/events/${evenementId}/jury/participants/${effectiveParticipantId}/revision`,
                        ...
                        {canPresident ? (
                            <>
                                <Button
                                    type="button"
                                    variant="outline"
                                    disabled={busyAction === `/module5/events/${evenementId}/jury/ouvrir-notation`}
                                    onClick={() => submitAction(`/module5/events/${evenementId}/jury/ouvrir-notation`, {}, 'Notation ouverte.')}
                                >
                                    {busyAction === `/module5/events/${evenementId}/jury/ouvrir-notation` ? <LoaderCircle className="size-4 animate-spin" /> : <Sparkles className="size-4" />}
                                    Ouvrir notation
                                </Button>
                                <Button
                                    type="button"
                                    variant="outline"
                                    disabled={busyAction === `/module5/events/${evenementId}/jury/fermer-notation`}
                                    onClick={() => submitAction(`/module5/events/${evenementId}/jury/fermer-notation`, {}, 'Notation fermee.')}
                                >
                                    {busyAction === `/module5/events/${evenementId}/jury/fermer-notation` ? <LoaderCircle className="size-4 animate-spin" /> : <Lock className="size-4" />}
                                    Fermer notation
                                </Button>
                                <Button
                                    type="button"
                                    disabled={busyAction === `/module5/events/${evenementId}/jury/finaliser`}
                                    onClick={() => submitAction(`/module5/events/${evenementId}/jury/finaliser`, {}, 'Classement final publie.')}
                                >
                                    {busyAction === `/module5/events/${evenementId}/jury/finaliser` ? <LoaderCircle className="size-4 animate-spin" /> : <CheckCheck className="size-4" />}
                                    Finaliser
                                </Button>
                            </>
                        ) : null}
                ...
                {canPresident ? (
                    <div className="rounded-[1.75rem] border border-slate-200 bg-white/95 p-5 shadow-sm dark:border-slate-800 dark:bg-slate-950/80">
                        ...
                        <div className="mt-4 flex flex-wrap gap-2">
                            ...
                            <Button type="button" onClick={handleSaveConfiguration} disabled={busyAction === `/module5/events/${evenementId}/jury/configurer`}>
                                {busyAction === `/module5/events/${evenementId}/jury/configurer` ? <LoaderCircle className="size-4 animate-spin" /> : <CheckCheck className="size-4" />}
