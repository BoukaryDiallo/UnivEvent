        ...
        () => [
            {
                ...
                manageRoute: canManage ? `/module5/events/${event.id}/edit#actors` : null,
            },
            {
                title: 'Organisateurs',
                ...
                manageRoute: `/module5/events/${event.id}/edit#actors`,
            },
            {
                title: 'Intervenants',
                ...
                : []),
            {
                ...
                manageRoute: `/module5/events/${event.id}#participants`,
            },
        ],
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                ...
                {canManage ? (
                    <Button asChild>
                        <Link href={`/module5/events/${event.id}/edit`}>
