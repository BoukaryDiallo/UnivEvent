...
import { GlobalFeedPanel } from '@/modules/module5/components/GlobalFeedPanel';
import { NotificationPanel } from '@/modules/module5/components/NotificationPanel';
            ...
            <div className="flex flex-1 flex-col gap-6 p-4 md:p-6">
                ...
                <div className="flex justify-center">
                    <Button asChild variant="outline" className="rounded-full">
                        <Link href="/module5/dashboard">Retour au tableau de bord</Link>
                    </Button>
                </div>
            </div>
        </AppLayout>
