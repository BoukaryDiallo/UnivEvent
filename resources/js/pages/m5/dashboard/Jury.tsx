...
export default function JuryDashboard({ concours_assignes, candidatures_a_evaluer, deliberations, stats }: JuryDashboardProps) {
    const breadcrumbs = [
            ...
            <div className="max-w-7xl mx-auto px-4 py-8 space-y-10">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="space-y-1">
                        ...
                        <p className="text-sm text-gray-500">Évaluez les candidatures et validez les résultats.</p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm flex items-center justify-between dark:bg-slate-950 dark:border-slate-800">
                        <div className="space-y-1">
                            <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Évaluations terminées</p>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        <h3 className="text-xl font-bold text-gray-900 dark:text-white">Concours assignés</h3>
                        <div className="bg-white rounded-[2.5rem] border border-gray-100 shadow-sm overflow-hidden dark:bg-slate-950 dark:border-slate-800">
                            <table className="w-full text-left">
                                <thead className="bg-gray-50 border-b border-gray-100 dark:bg-slate-900 dark:border-slate-800">
                                    <tr>
                                        <th className="px-8 py-5 text-[10px] font-bold text-gray-400 uppercase tracking-widest">Concours</th>
                                        <th className="px-8 py-5 text-[10px] font-bold text-gray-400 uppercase tracking-widest">Rôle</th>
                                        <th className="px-8 py-5 text-[10px] font-bold text-gray-400 uppercase tracking-widest">Statut</th>
                                        ...
                                        <tr key={i} className="group hover:bg-gray-50 transition-colors dark:hover:bg-slate-900/50">
                                            ...
                                            <td className="px-8 py-6">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span className="text-xs font-medium text-gray-600 dark:text-slate-400">Notation ouverte</span>
                                                </div>
                                            </td>
                                            <td className="px-8 py-6 text-right">
                                                <Button asChild className="rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-xs h-9">
                                                    <Link href={`/m5/jury/${item.concours.id}/panel`}>
                                                        Évaluer
                    ...
                    <div className="space-y-8">
                        <div className="bg-gray-900 rounded-[2.5rem] p-8 text-white">
                            ...
                            <div className="space-y-6">
                                {deliberations.length > 0 ? deliberations.map((del, i) => (
                        ...
                        <div className="bg-indigo-50 p-8 rounded-[2.5rem] border border-indigo-100 dark:bg-indigo-950/20 dark:border-indigo-900/30">
                            <h4 className="text-sm font-bold text-indigo-900 dark:text-indigo-400 mb-2">Guide du Jury</h4>
