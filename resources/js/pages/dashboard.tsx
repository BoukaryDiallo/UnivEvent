        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-1 flex-col gap-6 p-4 md:p-6">
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <Card className="flex flex-col justify-between rounded-3xl border-slate-200 shadow-sm transition-all hover:shadow-md dark:border-slate-800">
                        <CardHeader>
                            <div className="inline-flex size-12 items-center justify-center rounded-2xl bg-purple-100 text-purple-600 dark:bg-purple-950/30 dark:text-purple-300">
                                <Vote className="size-6" />
                            </div>
                            <CardTitle className="mt-4 text-xl">Élections</CardTitle>
                            <CardDescription>
                                Gérez les élections, consultez les candidatures et les résultats.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <Button asChild className="w-full rounded-full" variant="outline">
                    ...
                    <Card className="flex flex-col justify-between rounded-3xl border-slate-200 shadow-sm transition-all hover:shadow-md dark:border-slate-800">
                        <CardHeader>
                            <div className="inline-flex size-12 items-center justify-center rounded-2xl bg-green-100 text-green-600 dark:bg-green-950/30 dark:text-green-300">
                                <UserCheck className="size-6" />
                            </div>
                            <CardTitle className="mt-4 text-xl">Votes</CardTitle>
                            <CardDescription>
                                Consultez l'historique des votes et les résultats en direct.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <Button asChild className="w-full rounded-full" variant="outline">
                    ...
                    <Card className="flex flex-col justify-between rounded-3xl border-slate-200 shadow-sm transition-all hover:shadow-md dark:border-slate-800">
                        <CardHeader>
                            <div className="inline-flex size-12 items-center justify-center rounded-2xl bg-blue-100 text-blue-600 dark:bg-blue-950/30 dark:text-blue-300">
                                <UserCheck className="size-6" />
                            </div>
                            <CardTitle className="mt-4 text-xl">Candidatures</CardTitle>
                            <CardDescription>
                                Gérez les candidatures aux élections et validez les dossiers.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <Button asChild className="w-full rounded-full" variant="outline">
                    ...
                    <Card className="flex flex-col justify-between rounded-3xl border-slate-200 shadow-sm transition-all hover:shadow-md dark:border-slate-800">
                        <CardHeader>
                            <div className="inline-flex size-12 items-center justify-center rounded-2xl bg-orange-100 text-orange-600 dark:bg-orange-950/30 dark:text-orange-300">
                                <GitBranch className="size-6" />
                            </div>
                            <CardTitle className="mt-4 text-xl">Structure Académique</CardTitle>
                            <CardDescription>
                                Gérez les UFR, départements, filières et étudiants de l'université.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <div className="flex flex-col gap-2">
