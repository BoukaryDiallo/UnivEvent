...
class EvenementResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'comment_replies_enabled' => $this->comment_replies_enabled,
            'comment_reactions_enabled' => $this->comment_reactions_enabled,
            'comment_policy' => $this->comment_policy,
            'messages_enabled' => $this->messages_enabled,
            'evenement_certifie' => $this->evenement_certifie,
            ...
            'allow_participant_result_tracking' => $this->allow_participant_result_tracking,
            ...
            'participants_count' => $this->whenCounted('inscriptions', $this->inscriptions?->count() ?? 0),
            'comments_count' => $this->whenCounted('comments', $this->comments?->count() ?? 0),
            'activity_count' => $this->whenCounted('activities', $this->activities?->count() ?? 0),
            'cover_url' => $cover ? Storage::url($cover->chemin_fichier) : null,
            'roles' => $this->whenLoaded('roles', fn () => $this->roles->pluck('role')->values()),
